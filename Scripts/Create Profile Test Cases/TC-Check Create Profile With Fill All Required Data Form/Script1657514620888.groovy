...
Mobile.setText(findTestObject('Create Profile Objects/input_First Name'), 'lionel', 0)

Mobile.tap(findTestObject('Create Profile Objects/input_Last Name'), 0)

Mobile.setText(findTestObject('Create Profile Objects/input_Last Name'), 'messi', 0)

Mobile.tap(findTestObject('Create Profile Objects/input_Country'), 0)

Mobile.setText(findTestObject('Create Profile Objects/input_Country'), 'Argentina', 0)

Mobile.tap(findTestObject('Create Profile Objects/input_Username'), 0)

Mobile.setText(findTestObject('Create Profile Objects/input_Username'), 'lionelmessi', 0)

Mobile.tap(findTestObject('Create Profile Objects/input_Password'), 0)

Mobile.setText(findTestObject('Create Profile Objects/input_Password'), 'lionelMessi10', 0)

Mobile.tap(findTestObject('Create Profile Objects/input_Confirm Password'), 0)

Mobile.setText(findTestObject('Create Profile Objects/input_Confirm Password'), 'lionelMessi10', 0)
