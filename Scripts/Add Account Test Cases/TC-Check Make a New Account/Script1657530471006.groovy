...
Mobile.tap(findTestObject('Hamburger Menu Objects/Menu List Objects/menu_Accounts'), 0)
...
Mobile.setText(findTestObject('Hamburger Menu Objects/Accounts Page Objects/input_ Account Name'), 'BNI', 0)
